...
taxonomy_table_data_frame <- stag_db_report %>%
    ...
    mutate(genus_name = ifelse(grepl("^A.*", sm$genetic_coral_species_call), "Acropora",
                        ifelse(!is.na(sm$genetic_coral_species_call), "other", NA))) %>%
