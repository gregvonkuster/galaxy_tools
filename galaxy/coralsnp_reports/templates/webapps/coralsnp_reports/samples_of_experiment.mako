...
<div class="report">
    <div class="reportBody">
        ...
        <h4>
            Seq Facility: <b>${seq_facility}</b><br/>
            Array Version: <b>${array_version}</b><br/>
            Result Folder Name: <b>${result_folder_name}</b><br/>
            Plate Barcode: <b>${plate_barcode}</b><br/>
        </h4>
        <table align="center" class="colored">
            %if len(samples) == 0:
                <tr>
                    <td colspan="2">
                        There are no samples of this experiment
                    </td>
                </tr>
            %else:
                <tr class="header">
