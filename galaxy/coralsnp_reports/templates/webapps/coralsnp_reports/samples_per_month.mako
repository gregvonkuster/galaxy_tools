...
<div class="report">
    <div class="reportBody">
        <h3 align="center">Samples Per Month</h3>
        <h4 align="center">
            Click Month to view the number of samples
            for each day of that month
        </h4>
        <table align="center" width="30%" class="colored">
            %if len(samples) == 0:
                <tr><td colspan="2">There are no samples</td></tr>
            %else:
                <tr class="header">
                    <td class="half_width">
                    ...
                    <td class="half_width">
                        ${get_sort_url(sort_id, order, 'num_samples', 'samples', 'per_month', 'Number of Samples')}
