...
class Sample(Dictifiable):
    dict_collection_visible_keys = ['id', 'create_time', 'coral_mlg_clonal_id', 'sym_mlg_clonal_id', 'affy_id', 'sample_id', 'genotype_id', 'phenotype_id',
    ...
    def __init__(self, create_time=None, coral_mlg_clonal_id=None, sym_mlg_clonal_id=None, affy_id=None, sample_id=None, genotype_id=None, phenotype_id=None,
        ...
        self.coral_mlg_clonal_id = coral_mlg_clonal_id
        self.sym_mlg_clonal_id = sym_mlg_clonal_id
