...
CORALSNP_REPORTS_APP = App(
    ["coralsnp_reports_wsgi.ini", "config/coralsnp_reports.ini"],
    "8764",
    ["galaxy.webapps.coralsnp_reports.buildapp:app_factory"],
    "config/coralsnp_reports.yml",
    "lib/galaxy/webapps/coralsnp_reports/config_schema.yml",
    'galaxy.webapps.coralsnp_reports.buildapp:uwsgi_app()',
)
REPORTS_APP = App(
...
APPS = {"galaxy": GALAXY_APP, "tool_shed": SHED_APP, "reports": REPORTS_APP, "coralsnp_reports": CORALSNP_REPORTS_APP}
